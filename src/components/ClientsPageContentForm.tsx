...
const emptyContent: ClientsPageContent = {
  pageTitle: '',
  pageTitleEn: '',
  pageDescription: '',
  pageDescriptionEn: '',
...
const ClientsPageContentForm: React.FC = () => {
  const [activeLang, setActiveLang] = useState<'vi' | 'en'>('vi');
  const [formData, setFormData] = useState<ClientsPageContent>(emptyContent);
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <div className="space-y-2">
            ...
            <input
              ...
              placeholder={activeLang === 'vi' ? 'Ví dụ: Khách hàng tiêu biểu' : 'Example: Featured Clients'}
            />
          </div>
          <div className="space-y-2">
            ...
            <textarea
              ...
              placeholder={activeLang === 'vi' ? 'Mô tả ngắn về danh sách khách hàng...' : 'Short description about clients...'}
            />
          </div>
        </div>
...
export default ClientsPageContentForm;
